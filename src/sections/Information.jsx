  ...
  return (
    <section className="bg-hero-bg bg-cover bg-center h-screen flex items-center justify-center text-content-color mt-4">
      <div className="container max-w-3xl">
        ...
        <p className="text-gray-600 mb-11 text-left text-lg">
        ...
        <ul className="list-disc list-inside text-left mb-16">
          <li>
        ...
        <p className="text-content-color mb-11 text-left text-lg">
          Фокусът ни върху клиентите е същността на нашата работа. Ние доставяме
          услуги за всички видове бизнес – от малки местни предприятия до
          мултинационални компании.
        </p>
